!function e(t, n, r) {
  ...
  for (var i = 'function' == typeof require && require, a = 0; a < r.length;
       a++)
    o(r[a]);
  return o
}({
    ...
    function(e, t, n) {
      !function(e, n) {
        ...
        function r(e) {
          ...
          return 'function' !== n && !de.isWindow(e) &&
              ('array' === n || 0 === t ||
               'number' == typeof t && t > 0 && t - 1 in e)
        }
        function o(e, t, n) {
          return de.isFunction(t) ? de.grep(
                                        e,
                                        function(e, r) {
              ...
              'string' != typeof t ? de.grep(
                                         e,
                                         function(e) {
                                           return ae.call(t, e) > -1 !== n
                                         }) :
              ke.test(t) ? de.filter(t, e, n) :
                           (t = de.filter(t, e), de.grep(e, function(e) {
        ...
        function l(e, t, n) {
          var r;
          try {
            e && de.isFunction(r = e.promise)  ? r.call(e).done(t).fail(n) :
                e && de.isFunction(r = e.then) ? r.call(e, t, n) :
                                                 t.call(void 0, e)
          } catch (e) {
            n.call(void 0, e)
          }
        ...
        function c() {
          te.removeEventListener('DOMContentLoaded', c),
              e.removeEventListener('load', c), de.ready()
        }
        function f() {
        ...
        function g(e) {
          ...
          return o ? o :
                     (t = n.body.appendChild(n.createElement(r)),
                      o = de.css(t, 'display'), t.parentNode.removeChild(t),
                      'none' === o && (o = 'block'), Ue[r] = o, o)
        }
        function m(e, t) {
            ...
            r.style &&
                (n = r.style.display,
                 t ? ('none' === n &&
                     ...
                     'none' !== n && (o[i] = 'none', Fe.set(r, 'display', n)));
        ...
        function b(e, t, n, r, o) {
          for (var i, a, s, u, l, c, f = t.createDocumentFragment(), p = [],
                                     h = 0, d = e.length;
               h < d; h++)
            if (i = e[h], i || 0 === i)
              if ('object' === de.type(i))
                ...
                for (a = a || f.appendChild(t.createElement('div')),
                    ...
                    u = Ve[s] || Ve._default,
                    a.innerHTML = u[1] + de.htmlPrefilter(i) + u[2], c = u[0];
                     c--;)
                  a = a.lastChild;
          ...
          for (f.textContent = '', h = 0; i = p[h++];)
            if (r && de.inArray(i, r) > -1)
              o && o.push(i);
                ...
                a = v(f.appendChild(i), 'script'), l && y(a), n)
        ...
        function T(e, t, n, r, o, i) {
          ...
          if (null == r && null == o ? (o = n, r = n = void 0) :
                                       null == o &&
                      ('string' == typeof n ? (o = r, r = void 0) :
                                              (o = r, r = n, n = void 0)),
              o === !1)
            o = w;
          else if (!o)
        ...
        function A(e, t, r, o) {
          t = oe.apply([], t);
          var i, a, s, u, l, c, f = 0, p = e.length, h = p - 1, d = t[0],
                                g = de.isFunction(d);
          if (g ||
          ...
          if (p &&
              (i = b(t, e[0].ownerDocument, !1, e, o), a = i.firstChild,
               1 === i.childNodes.length && (i = a), a || o)) {
            for (s = de.map(v(i, 'script'), j), u = s.length; f < p; f++)
              l = i,
              f !== h &&
                  (l = de.clone(l, !0, !0), u && de.merge(s, v(l, 'script'))),
              r.call(e[f], l, f);
            if (u)
              for (c = s[s.length - 1].ownerDocument, de.map(s, E), f = 0;
                   f < u; f++)
                l = s[f],
                Ke.test(l.type || '') && !Fe.access(l, 'globalEval') &&
                    de.contains(c, l) &&
                    (l.src ? de._evalUrl && de._evalUrl(l.src) :
                             n(l.textContent.replace(ot, ''), c))
          }
          return e
        }
        function q(e, t, n) {
          for (var r, o = t ? de.filter(t, e) : e, i = 0; null != (r = o[i]);
               i++)
          ...
          return n = n || st(e),
                 n &&
                     (a = n.getPropertyValue(t) || n[t],
                      '' !== a || de.contains(e.ownerDocument, e) ||
                          (a = de.style(e, t)),
                      !pe.pixelMarginRight() && at.test(a) && it.test(t) &&
                          (r = s.width, o = s.minWidth, i = s.maxWidth,
                           s.minWidth = s.maxWidth = s.width = a, a = n.width,
                           s.width = r, s.minWidth = o, s.maxWidth = i)),
                 void 0 !== a ? a + '' : a
        }
        function O(e, t) {
          return {
        ...
        function F(e, t, n, r, o) {
          var i, a = 0;
          for (i = n === (r ? 'border' : 'content') ? 4 :
                   'width' === t                    ? 1 :
                                                      0;
               i < 4; i += 2)
            'margin' === n && (a += de.css(e, n + _e[i], !0, o)),
                r ?
                ('content' === n && (a -= de.css(e, 'padding' + _e[i], !0, o)),
                 'margin' !== n &&
        ...
        function P(e, t, n) {
          ...
          if (e.getClientRects().length && (r = e.getBoundingClientRect()[t]),
              r <= 0 || null == r) {
            if (r = D(e, t, i), (r < 0 || null == r) && (r = e.style[t]),
                at.test(r))
              return r;
        ...
        function _(e, t, n) {
          for (var r, o = (U.tweeners[t] || []).concat(U.tweeners['*']), i = 0,
                      a = o.length;
               i < a; i++)
        ...
        function W(e, t, n) {
          var r, o, i, a, s, u, l, c,
              f = 'width' in t || 'height' in t, p = this, h = {}, d = e.style,
          ...
          if (u = !de.isEmptyObject(t), u || !de.isEmptyObject(h)) {
            f && 1 === e.nodeType &&
                (n.overflow = [d.overflow, d.overflowX, d.overflowY],
                 l = v && v.display, null == l && (l = Fe.get(e, 'display')),
                 c = de.css(e, 'display'),
                 'none' === c &&
                     (l ? c = l :
                          (m([e], !0), l = e.style.display || l,
                           c = de.css(e, 'display'), m([e]))),
                ...
                n.overflow && (d.overflow = 'hidden', p.always(function() {
                  d.overflow = n.overflow[0], d.overflowX = n.overflow[1],
        ...
        function B(e, t) {
          var n, r, o, i, a;
          for (n in e)
            if (r = de.camelCase(n), o = t[r], i = e[n],
                de.isArray(i) && (o = i[1], i = e[n] = i[0]),
                n !== r && (e[r] = i, delete e[n]), a = de.cssHooks[r],
                a && 'expand' in a) {
        ...
        function U(e, t, n) {
          var r, o,
              ...
              l = s.promise({
                ...
                props: de.extend({}, t),
                opts: de.extend(
                    !0, {specialEasing: {}, easing: de.easing._default}, n),
        ...
        var ee = [], te = e.document, ne = Object.getPrototypeOf, re = ee.slice,
            oe = ee.concat, ie = ee.push, ae = ee.indexOf, se = {},
            ue = se.toString, le = se.hasOwnProperty, ce = le.toString,
            fe = ce.call(Object), pe = {}, he = '3.1.1',
            de =
                function(e, t) {
              return new de.fn.init(e, t)
            },
            ge = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, me = /^-ms-/,
            ve = /-([a-z])/g, ye = function(e, t) {
        ...
        de.extend = de.fn.extend =
            function() {
          var e, t, n, r, o, i, a = arguments[0] || {}, s = 1,
          ...
          for ('boolean' == typeof a && (l = a, a = arguments[s] || {}, s++),
            ...
            if (null != (e = arguments[s]))
              for (t in e)
                n = a[t], r = e[t],
                a !== r &&
                    (l && r && (de.isPlainObject(r) || (o = de.isArray(r))) ?
                         (o ? (o = !1, i = n && de.isArray(n) ? n : []) :
        ...
        var be = function(e) {
            ...
            if (!r &&
                ...
                if (o = u[1]) {
                  if (9 === d) {
                    ...
                    if (a.id === o) return n.push(a), n
                      ...
                      p && (a = p.getElementById(o)) && M(t, a) && a.id === o)
                    return n.push(a), n
                } else {
                  if (u[2]) return J.apply(n, t.getElementsByTagName(e)), n;
                  if ((o = u[3]) && C.getElementsByClassName &&
              ...
              if (C.qsa && !X[e + ' '] && (!P || !P.test(e))) {
                if (1 !== d)
                  ...
                  for ((s = t.getAttribute('id')) ? s = s.replace(we, Ce) :
                                                    t.setAttribute('id', s = $),
                                                    l = E(e), i = l.length;
                       i--;)
                    l[i] = '#' + s + ' ' + h(l[i]);
          ...
          function d(e, t, n) {
            var r = t.dir, o = t.next, i = o || r, a = n && 'parentNode' === i,
                s = B++;
          ...
          function b(e) {
            for (var t, n, r,
                 o = e.length, i = T.relative[e[0].type],
                 a = i || T.relative[' '], s = i ? 1 : 0,
                 u = d(
                     function(e) {
                       return e === t
                     },
              ...
              if (n = T.relative[e[s].type])
                ...
                if (n = T.filter[e[s].type].apply(null, e[s].matches), n[$]) {
                  ...
                  return y(
                      s > 1 && g(c),
                      s > 1 && h(e.slice(0, s - 1).concat({
                                 value: ' ' === e[s - 2].type ? '*' : ''
                               })).replace(se, '$1'),
                      n, s < r && b(e.slice(s, r)), r < o && b(e = e.slice(r)),
                      r < o && h(e))
                }
                c.push(n)
              }
            ...
            var o = n.length > 0, i = e.length > 0,
                a = function(r, a, s, u, l) {
                  ...
                  for (l && (A = a === L || a || l);
                       d !== w && null != (c = b[d]); d++) {
                    if (i && c) {
                      for (f = 0, a || c.ownerDocument === L || (O(c), s = !F);
                           p = e[f++];)
                        if (p(c, a || L, s)) {
                          u.push(c);
                          break
          ...
          var w, C, T, k, j, E, N, S, A, q, D, O, L, H, F, P, I, R, M,
              $ = 'sizzle' + 1 * new Date, _ = e.document, W = 0, B = 0,
              U = n(), z = n(), X = n(),
              K =
                  function(e, t) {
                return e === t && (D = !0), 0
              },
              V = {}.hasOwnProperty, G = [], Y = G.pop, Q = G.push, J = G.push,
              Z = G.slice,
              ee =
                  function(e, t) {
                for (var n = 0, r = e.length; n < r; n++)
              ...
              fe = new RegExp(ie), pe = new RegExp('^' + re + '$'), he = {
                ID: new RegExp('^#(' + re + ')'),
                CLASS: new RegExp('^\\.(' + re + ')'),
                TAG: new RegExp('^(' + re + '|[*])'),
                ATTR: new RegExp('^' + oe),
              ...
              de = /^(?:input|select|textarea|button)$/i, ge = /^h\d$/i,
              me = /^[^{]+\{\s*\[native \w/,
              ve = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ye = /[+~]/,
              be = new RegExp(
                  '\\\\([\\da-f]{1,6}' + ne + '?|(' + ne + ')|.)', 'ig'),
          ...
          O = t.setDocument =
            ...
            return r !== L && 9 === r.nodeType && r.documentElement ?
                (L = r, H = L.documentElement, F = !j(L),
                 _ !== L && (n = L.defaultView) && n.top !== n &&
                     (n.addEventListener ?
                 ...
                 K = t ?
                     ...
                     function(e, t) {
                       if (e === t) return D = !0, 0;
                       var n, r = 0, o = e.parentNode, i = t.parentNode,
                              s = [e], u = [t];
                       if (!o || !i)
                         return e === L ? -1 :
                             t === L    ? 1 :
          ...
          t.matchesSelector =
            ...
            if ((e.ownerDocument || e) !== L && O(e),
                n = n.replace(ce, '=\'$1\']'),
                C.matchesSelector && F && !X[n + ' '] && (!I || !I.test(n)) &&
                    (!P || !P.test(n)))
              try {
                var r = R.call(e, n);
          ...
          t.attr =
            ...
            var n = T.attrHandle[t.toLowerCase()],
                r = n && V.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !F) :
                                                                 void 0;
            return void 0 !== r                            ? r :
                C.attributes || !F                         ? e.getAttribute(t) :
          ...
          t.uniqueSort =
              function(e) {
            var t, n = [], r = 0, o = 0;
            if (D = !C.detectDuplicates, q = !C.sortStable && e.slice(0),
                e.sort(K), D) {
          ...
          T = t.selectors = {
            ...
            filter: {
              ...
              CHILD: function(e, t, n, r, o) {
                var i = 'nth' !== e.slice(0, 3), a = 'last' !== e.slice(-4),
                    s = 'of-type' === t;
                return 1 === r && 0 === o ? function(e) {
                  ...
                  var l, c, f, p, h, d,
                      ...
                      m = t.parentNode, v = s && t.nodeName.toLowerCase(),
                      y = !u && !s, b = !1;
                  if (m) {
                    if (i) {
                      for (; g;) {
                    ...
                    if (d = [a ? m.firstChild : m.lastChild], a && y) {
                      for (p = m, f = p[$] || (p[$] = {}),
                        ...
                        y &&
                            (p = t, f = p[$] || (p[$] = {}),
                             c = f[p.uniqueID] || (f[p.uniqueID] = {}),
                             l = c[e] || [], h = l[0] === W && l[1], b = h),
                        b === !1)
                      for (; (p = ++h && p && p[g] || (b = h = 0) || d.pop()) &&
                           ((s ? p.nodeName.toLowerCase() !== v :
                                 1 !== p.nodeType) ||
                            !++b ||
                            (y &&
                                 (f = p[$] || (p[$] = {}),
              ...
              PSEUDO: function(e, n) {
                var o,
                    i = T.pseudos[e] || T.setFilters[e.toLowerCase()] ||
            ...
            pseudos: {
              ...
              focus: function(e) {
                return e === L.activeElement && (!L.hasFocus || L.hasFocus()) &&
          ...
          return p.prototype = T.filters = T.pseudos, T.setFilters = new p,
                 E = t.tokenize =
                     function(e, n) {
                 ...
                 S = t.select =
                   ...
                   if (n = n || [], 1 === c.length) {
                     if (i = c[0] = c[0].slice(0),
                         i.length > 2 && 'ID' === (a = i[0]).type &&
                             9 === t.nodeType && F && T.relative[i[1].type]) {
                       if (t =
                               (T.find.ID(a.matches[0].replace(be, xe), t) ||
                                [])[0],
                           !t)
                         return n;
                       l && (t = t.parentNode),
                     ...
                     for (o = he.needsContext.test(e) ? 0 : i.length;
        ...
        de.uniqueSort = de.unique = be.uniqueSort, de.text = be.getText,
        de.isXMLDoc = be.isXML, de.contains = be.contains,
        ...
        de.filter = function(e, t, n) {
          ...
          return n && (e = ':not(' + e + ')'),
                 1 === t.length && 1 === r.nodeType ?
                     de.find.matchesSelector(r, e) ? [r] : [] :
                     de.find.matches(e, de.grep(t, function(e) {
                       return 1 === e.nodeType
                     }))
        }, de.fn.extend({
          find: function(e) {
          ...
          is: function(e) {
            return !!o(this,
                       'string' == typeof e && Ce.test(e) ? de(e) : e || [], !1)
                         .length
          }
        });
        var je,
                ...
                if (r[1]) {
                  if (t = t instanceof de ? t[0] : t,
                      de.merge(
                          this,
                          de.parseHTML(
                              r[1], t && t.nodeType ? t.ownerDocument || t : te,
                              !0)),
                      Te.test(r[1]) && de.isPlainObject(t))
                    for (r in t)
                      de.isFunction(this[r]) ? this[r](t[r]) :
                                               this.attr(r, t[r]);
                  return this
                }
                return o = te.getElementById(r[2]),
                       o && (this[0] = o, this.length = 1), this
              }
              return e.nodeType    ? (this[0] = e, this.length = 1, this) :
                  de.isFunction(e) ? void 0 !== n.ready ? n.ready(e) : e(de) :
                                     de.makeArray(e, this)
            };
        ...
        de.Callbacks = function(e) {
          ...
          var t, n, r, o, i = [], s = [], u = -1, l = function() {
            for (o = e.once, r = t = !0; s.length; u = -1)
              for (n = s.shift(); ++u < i.length;)
                i[u].apply(n[0], n[1]) === !1 && e.stopOnFalse &&
                    (u = i.length, n = !1);
            ...
            var n =
                    [
                      [
                        ...
                        de.Callbacks('memory'), 2
                      ],
                      [
                        'resolve', 'done', de.Callbacks('once memory'),
                        de.Callbacks('once memory'), 0, 'resolved'
                      ],
                      [
                        'reject', 'fail', de.Callbacks('once memory'),
                        de.Callbacks('once memory'), 1, 'rejected'
                      ]
                    ],
                r = 'pending', o = {
                  state: function() {
                        ...
                        var l = this, c = arguments, f = function() {
                          ...
                          if (!(t < a)) {
                            ...
                            f = e &&
                                ...
                                e.then,
                            de.isFunction(f) ?
                                o ? f.call(e, i(a, n, s, o), i(a, n, u, o)) :
                                    (a++,
                                     f.call(
                                         e, i(a, n, s, o), i(a, n, u, o),
          ...
          when: function(e) {
            var t = arguments.length, n = t, r = Array(n),
                o = re.call(arguments), i = de.Deferred(), a = function(e) {
                  return function(n) {
                    r[e] = this,
        ...
        de.Deferred.exceptionHook = function(t, n) {
          e.console && e.console.warn && t && De.test(t.name) &&
              e.console.warn(
            ...
            if (void 0 !== r) {
              if (void 0 !== t) {
                de.isArray(t) ?
                    ...
                    (t = de.camelCase(t), t = t in r ? [t] : t.match(qe) || []),
                    n = t.length;
                for (; n--;) delete r[t[n]]
              }
        ...
        var Fe = new f, Pe = new f, Ie = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,
            Re = /[A-Z]/g;
        de.extend({
          hasData: function(e) {
          ...
          _removeData: function(e, t) {
            ...
            de.extend({
              queue: function(e, t, n) {
                var r;
                if (e)
                  return t = (t || 'fx') + 'queue', r = Fe.get(e, t),
                         n &&
                             (!r || de.isArray(n) ?
              ...
              dequeue: function(e, t) {
                t = t || 'fx';
                var n = de.queue(e, t), r = n.length, o = n.shift(),
                    i = de._queueHooks(e, t), a = function() {
                      de.dequeue(e, t)
                    };
                'inprogress' === o && (o = n.shift(), r--),
                    o &&
                    ('fx' === t && n.unshift('inprogress'), delete i.stop,
                     o.call(e, a, i)),
                    !r && i && i.empty.fire()
              },
            ...
            de.fn.extend({
              ...
              promise: function(e, t) {
                var n, r = 1, o = de.Deferred(), i = this, a = this.length,
                       s = function() {
                         --r || o.resolveWith(i, [i])
                       };
        ...
        var Me = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            ...
            _e = ['Top', 'Right', 'Bottom', 'Left'], We = function(e, t) {
              return e = t || e,
        ...
        de.event = {
          ...
          add: function(e, t, n, r, o) {
            ...
            if (m)
              for (n.handler && (i = n, n = i.handler, o = i.selector),
                   ...
                   t = (t || '').match(qe) || [''], l = t.length;
                   l--;)
                s = Ze.exec(t[l]) || [], h = g = s[1],
                d = (s[2] || '').split('.').sort(),
                h &&
                     ...
                     c = de.extend(
                         {
                           ...
                           selector: o,
                           needsContext:
                               o && de.expr.match.needsContext.test(o),
                           namespace: d.join('.')
                         },
                         i),
                     (p = u[h]) ||
                         (p = u[h] = [], p.delegateCount = 0,
                ...
                if (s = Ze.exec(t[l]) || [], h = g = s[1],
                  ...
                  for (f = de.event.special[h] || {},
                      ...
                      a = i = p.length;
                       i--;)
                    c = p[i],
                    !o && g !== c.origType || n && n.guid !== c.guid ||
                        s && !s.test(c.namespace) ||
                        r && r !== c.selector && ('**' !== r || !c.selector) ||
                        (p.splice(i, 1), c.selector && p.delegateCount--,
          ...
          dispatch: function(e) {
            var t, n, r, o, i, a,
                s = de.event.fix(e), u = new Array(arguments.length),
            ...
            if (s.delegateTarget = this,
              ...
              for (a = de.event.handlers.call(this, s, l), t = 0;
                ...
                for (s.currentTarget = o.elem, n = 0; (i = o.handlers[n++]) &&
                     !s.isImmediatePropagationStopped();)
                  s.rnamespace && !s.rnamespace.test(i.namespace) ||
                      (s.handleObj = i, s.data = i.data,
                       r = ((de.event.special[i.origType] || {}).handle ||
                            i.handler)
                               .apply(o.elem, u),
        ...
        de.each(
            {
              ...
              which: function(e) {
                ...
                return null == e.which && Qe.test(e.type) ?
                    ...
                    !e.which && void 0 !== t && Je.test(e.type) ? 1 & t ? 1 :
                        2 & t                                           ? 3 :
                        4 & t                                           ? 2 :
                                                                          0 :
                                                                  e.which
            ...
            function(e, t) {
              de.event.special[e] = {
                ...
                handle: function(e) {
                  ...
                  return o && (o === r || de.contains(r, o)) ||
                             (e.type = i.origType,
                              n = i.handler.apply(this, arguments), e.type = t),
                         n
                }
              }
            }),
        ...
        var et =
            ...
            nt = /checked\s*(?:[^=]|=\s*.checked.)/i, rt = /^true\/(.*)/,
            ot = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
        de.extend({
          ...
          clone: function(e, t, n) {
            ...
            if (!(pe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType ||
                  de.isXMLDoc(e)))
              for (a = v(s), i = v(e), r = 0, o = i.length; r < o; r++)
                S(i[r], a[r]);
            if (t)
              if (n)
                for (i = i || v(e), a = a || v(s), r = 0, o = i.length; r < o;
                     r++)
                  N(i[r], a[r]);
              else
                N(e, s);
            return a = v(s, 'script'),
                   a.length > 0 && y(a, !u && v(e, 'script')), s
          },
          cleanData: function(e) {
            for (var t, n, r, o = de.event.special, i = 0;
                 void 0 !== (n = e[i]); i++)
              if (He(n)) {
                if (t = n[Fe.expando]) {
                  if (t.events)
                    for (r in t.events)
                      o[r] ? de.event.remove(n, r) :
            ...
            de.each(
                ...
                function(e, t) {
                  de.fn[e] = function(e) {
                    for (var n, r = [], o = de(e), i = o.length - 1, a = 0;
                         a <= i; a++)
                      n = a === i ? this : this.clone(!0), de(o[a])[t](n),
                      ie.apply(r, n.get());
                    return this.pushStack(r)
                  }
                });
        var it = /^margin/, at = new RegExp('^(' + Me + ')(?!px)[a-z%]+$', 'i'),
            st = function(t) {
        ...
        !function() {
          function t() {
            if (s) {
              ...
              n = '1%' !== t.top, i = '2px' === t.marginLeft,
              r = '4px' === t.width, s.style.marginRight = '50%',
              o = '4px' === t.marginRight, Ye.removeChild(a), s = null
            }
          }
        ...
        var ut = /^(none|table(?!-c[ea]).+)/,
            ...
            ft = ['Webkit', 'Moz', 'ms'], pt = te.createElement('div').style;
        de.extend({
          cssHooks: {
            opacity: {
              get: function(e, t) {
            ...
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
              ...
              return t = de.cssProps[s] || (de.cssProps[s] = L(s) || s),
                     ...
                     void 0 === n ?
                         ...
                         u[t] :
                         (i = typeof n,
                          'string' === i && (o = $e.exec(n)) && o[1] &&
                              (n = d(e, t, o), i = 'number'),
                          null != n && n === n &&
                              ('number' === i &&
                                   (n +=
                                    o && o[3] || (de.cssNumber[s] ? '' : 'px')),
          ...
          css: function(e, t, n, r) {
                  ...
                  de.cssHooks[t] = {
                    ...
                    set: function(e, n, r) {
                      var o, i = r && st(e),
                             a = r &&
                          F(e, t, r,
                            'border-box' === de.css(e, 'boxSizing', !1, i), i);
                      return a && (o = $e.exec(n)) && 'px' !== (o[3] || 'px') &&
                                 (e.style[t] = n, n = de.css(e, t)),
                             H(e, n, a)
                    }
                  }
                }),
            de.cssHooks.marginLeft =
                O(pe.reliableMarginLeft,
                  function(e, t) {
                    if (t)
                      return (parseFloat(D(e, 'marginLeft')) ||
            ...
            de.Tween = I, I.prototype = {
              ...
              init: function(e, t, n, r, o, i) {
                ...
                this.easing = o || de.easing._default, this.options = t,
              ...
              run: function(e) {
                ...
                return this.options.duration ?
                           this.pos = t = de.easing[this.easing](
            ...
            I.prototype.init.prototype = I.prototype, I.propHooks = {
              _default: {
                ...
                set: function(e) {
                  de.fx.step[e.prop] ? de.fx.step[e.prop](e) :
                      1 !== e.elem.nodeType ||
        ...
        de.Animation = de.extend(U, {
          ...
          tweener: function(e, t) {
            ...
            for (var n, r = 0, o = e.length; r < o; r++)
              n = e[r], U.tweeners[n] = U.tweeners[n] || [],
        ...
        de.fn.extend({
          ...
          stop: function(e, t, n) {
            ...
            return 'string' != typeof e && (n = t, t = e, e = void 0),
                   ...
                   this.each(function() {
                     var t = !0, o = null != e && e + 'queueHooks',
                         i = de.timers, a = Fe.get(this);
                     if (o)
                       a[o] && a[o].stop && r(a[o]);
                     else
                       for (o in a) a[o] && a[o].stop && mt.test(o) && r(a[o]);
                     for (o = i.length; o--;)
                       i[o].elem !== this || null != e && i[o].queue !== e ||
          ...
          finish: function(e) {
            return e !== !1 && (e = e || 'fx'), this.each(function() {
              var t, n = Fe.get(this), r = n[e + 'queue'],
                     o = n[e + 'queueHooks'], i = de.timers,
                     a = r ? r.length : 0;
              for (n.finish = !0, de.queue(this, e, []),
                  o && o.stop && o.stop.call(this, !0), t = i.length;
                   t--;)
                i[t].elem === this && i[t].queue === e &&
        ...
        de.fx.stop =
            function() {
          e.cancelAnimationFrame ? e.cancelAnimationFrame(dt) :
                                   e.clearInterval(dt),
              dt = null
        },
        ...
        de.fn.delay = function(t, n) {
          ...
          e.type = 'checkbox', pe.checkOn = '' !== e.value,
          pe.optSelected = n.selected, e = te.createElement('input'),
              ...
              attr: function(e, t, n) {
                ...
                if (3 !== i && 8 !== i && 2 !== i)
                  return 'undefined' == typeof e.getAttribute ?
                      de.prop(e, t, n) :
                      (1 === i && de.isXMLDoc(e) ||
                           (o = de.attrHooks[t.toLowerCase()] ||
                                (de.expr.match.bool.test(t) ? vt : void 0)),
                       void 0 !== n ?
                           null === n ? void de.removeAttr(e, t) :
                               o && 'set' in o &&
              ...
              toggleClass: function(e, t) {
                ...
                return 'boolean' == typeof t && 'string' === n ?
                    ...
                    this.each(function() {
                      var t, r, o, i;
                      if ('string' === n)
                        for (r = 0, o = de(this), i = e.match(qe) || [];
                             t = i[r++];)
                          o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                      else
                        void 0 !== e && 'boolean' !== n ||
                            (t = X(this), t && Fe.set(this, '__className__', t),
                             this.setAttribute &&
                                 this.setAttribute(
                                     'class',
                                     t || e === !1 ?
          ...
          val: function(e) {
            ...
            de.extend({
              valHooks: {
                ...
                select: {
                  get: function(e) {
                    var t, n, r, o = e.options, i = e.selectedIndex,
                                 a = 'select-one' === e.type, s = a ? null : [],
                                 u = a ? i + 1 : o.length;
                    for (r = i < 0 ? u : a ? i : 0; r < u; r++)
                      if (n = o[r],
                          (n.selected || r === i) && !n.disabled &&
                  ...
                  set: function(e, t) {
                    for (var n, r, o = e.options, i = de.makeArray(t),
                                   a = o.length;
                         a--;)
                      r = o[a],
                      (r.selected =
        ...
        de.extend(de.event, {
          trigger: function(t, n, r, o) {
            var i, a, s, u, l, c, f,
                p = [r || te], h = le.call(t, 'type') ? t.type : t,
                d = le.call(t, 'namespace') ? t.namespace.split('.') : [];
            if (a = s = r = r || te,
                3 !== r.nodeType && 8 !== r.nodeType &&
                    ...
                    (h.indexOf('.') > -1 &&
                     ...
                     t.isTrigger = o ? 2 : 3, t.namespace = d.join('.'),
              ...
              return t.type = h,
                     o || t.isDefaultPrevented() ||
                         ...
                         !He(r) ||
                         l && de.isFunction(r[h]) && !de.isWindow(r) &&
                             (s = r[l], s && (r[l] = null),
                              de.event.triggered = h, r[h](),
                              de.event.triggered = void 0, s && (r[l] = s)),
                     t.result
            }
          },
        ...
        de.param = function(e, t) {
          ...
          serializeArray: function() {
            return this
                ...
                .filter(function() {
                  var e = this.type;
                  return this.name && !de(this).is(':disabled') &&
                      At.test(this.nodeName) && !St.test(e) &&
        ...
        var qt = /%20/g, Dt = /#.*$/, Ot = /([?&])_=[^&]*/,
            ...
            Ft = /^(?:GET|HEAD)$/, Pt = /^\/\//, It = {}, Rt = {},
            Mt = '*/'.concat('*'), $t = te.createElement('a');
        $t.href = Tt.href, de.extend({
          ...
          ajax: function(t, n) {
            function r(t, n, r, s) {
              var l, p, h, x, w, C = n;
              c ||
                  (c = !0, u && e.clearTimeout(u), o = void 0, a = s || '',
                   T.readyState = t > 0 ? 4 : 0,
                   l = t >= 200 && t < 300 || 304 === t, r && (x = Q(d, T, r)),
                   x = J(d, x, T, l),
                   l ? (d.ifModified &&
                            (w = T.getResponseHeader('Last-Modified'),
                             ...
                             w && (de.etag[i] = w)),
                        204 === t || 'HEAD' === d.type ? C = 'nocontent' :
                            304 === t                  ? C = 'notmodified' :
                                        (C = x.state, p = x.data, h = x.error,
                                         l = !h)) :
                       (h = C, !t && C || (C = 'error', t < 0 && (t = 0))),
                   T.status = t, T.statusText = (n || C) + '',
                   l ? v.resolveWith(g, [p, C, T]) : v.rejectWith(g, [T, C, h]),
                   T.statusCode(b), b = void 0,
                   f &&
                       m.trigger(
                           l ? 'ajaxSuccess' : 'ajaxError', [T, d, l ? p : h]),
                   y.fireWith(g, [T, C]),
                   f &&
            ...
            var o, i, a, s, u, l, c, f, p, h,
                d = de.ajaxSetup({}, n), g = d.context || d,
                m = d.context && (g.nodeType || g.jquery) ? de(g) : de.event,
                v = de.Deferred(), y = de.Callbacks('once memory'),
                b = d.statusCode || {}, x = {}, w = {}, C = 'canceled', T = {
                  readyState: 0,
            ...
            if (v.promise(T),
                d.url = ((t || d.url || Tt.href) +
                         '').replace(Pt, Tt.protocol + '//'),
                d.type = n.method || n.type || d.method || d.type,
                d.dataTypes =
                    (d.dataType || '*').toLowerCase().match(qe) || [''],
                null == d.crossDomain) {
              l = te.createElement('a');
              try {
                l.href = d.url, l.href = l.href,
                d.crossDomain =
            ...
            d.type = d.type.toUpperCase(), d.hasContent = !Ft.test(d.type),
            i = d.url.replace(Dt, ''),
            d.hasContent ?
            ...
            d.ifModified &&
                (de.lastModified[i] &&
                     T.setRequestHeader(
                         'If-Modified-Since', de.lastModified[i]),
            ...
            if (d.beforeSend && (d.beforeSend.call(g, T, d) === !1 || c))
              return T.abort();
            if (C = 'abort', y.add(d.complete), T.done(d.success),
                T.fail(d.error), o = G(Rt, d, n, T)) {
        ...
        pe.cors = !!Wt && 'withCredentials' in Wt, pe.ajax = Wt = !!Wt,
          ...
          if (pe.cors || Wt && !t.crossDomain) return {
              send: function(o, i) {
                ...
                t.mimeType && s.overrideMimeType &&
                    ...
                    t.crossDomain || o['X-Requested-With'] ||
                ...
                n =
                  ...
                  return function() {
                    n &&
                        (n = r = s.onload = s.onerror = s.onabort =
                         ...
                         'abort' === e ?
                             ...
                             i(_t[s.status] || s.status, s.statusText,
          ...
          jsonpCallback: function() {
            ...
            de.ajaxPrefilter(
                ...
                function(t, n, r) {
                  ...
                  if (s || 'jsonp' === t.dataTypes[0])
                    return o = t.jsonpCallback =
                               de.isFunction(t.jsonpCallback) ?
                               t.jsonpCallback() :
                               t.jsonpCallback,
                           s ? t[s] = t[s].replace(Ut, '$1' + o) :
                               t.jsonp !== !1 &&
                                   (t.url += (jt.test(t.url) ? '&' : '?') +
                                        t.jsonp + '=' + o),
                           ...
                           t.dataTypes[0] = 'json', i = e[o],
                           e[o] =
                               function() {
                             a = arguments
                           },
                           r.always(function() {
                             void 0 === i ? de(e).removeProp(o) :
                                            e[o] = i,
                                            t[o] &&
            ...
            de.parseHTML =
              ...
              return t ||
                     ...
                     o ? [t.createElement(o[1])] :
                         (o = b([e], t, i), i && i.length && de(i).remove(),
            ...
            de.offset = {
              setOffset: function(e, t, n) {
                var r, o, i, a, s, u, l, c = de.css(e, 'position'), f = de(e),
                                         p = {};
                'static' === c && (e.style.position = 'relative'),
                    s = f.offset(), i = de.css(e, 'top'), u = de.css(e, 'left'),
                    l = ('absolute' === c || 'fixed' === c) &&
                    (i + u).indexOf('auto') > -1,
                    l ? (r = f.position(), a = r.top, o = r.left) :
            ...
            de.fn.extend({
              ...
              position: function() {
                if (this[0]) {
                  ...
                  return 'fixed' === de.css(n, 'position') ?
                             ...
                             (e = this.offsetParent(), t = this.offset(),
                              ...
                              r = {
                                ...
                                left:
                                    r.left + de.css(e[0], 'borderLeftWidth', !0)
                              }),
                  {
  ...
  2: [
    function(e, t, n) {
      !function(e, n, r) {
        function o(e, t, n) {
          return e.addEventListener ? void e.addEventListener(t, n, !1) :
        ...
        function s(e) {
          var t = [];
          return e.shiftKey && t.push('shift'), e.altKey && t.push('alt'),
                 e.ctrlKey && t.push('ctrl'), e.metaKey && t.push('meta'), t
        }
        function u(e) {
        ...
        function l(e) {
          return e.stopPropagation ? void e.stopPropagation() :
        ...
        function p(e, t, n) {
          return n || (n = f()[e] ? 'keydown' : 'keypress'),
                 'keypress' == n && t.length && (n = 'keydown'), n
        }
        function h(e) {
          return '+' === e ? ['+'] :
        ...
        function m(e) {
          ...
          function r(e, t, n, r, o, i) {
            ...
            for ('keyup' == f && c(e) && (t = [e]), s = 0;
                 s < y._callbacks[e].length; ++s)
              if (u = y._callbacks[e][s],
                  (r || !u.seq || x[u.seq] == u.level) && f == u.action &&
          ...
          function p(e) {
            ...
            var t = i(e);
            if (t)
              return 'keyup' == e.type && w === t ? void (w = !1) :
          ...
          function v(e, t, n, o, i) {
            ...
            return s.length > 1 ?
                void g(e, s, t, n) :
                (a = d(e, n), y._callbacks[a.key] = y._callbacks[a.key] || [],
        ...
        if (e) {
          ...
          m.prototype.bind =
            ...
            return e = e instanceof Array ? e : [e],
                   r._bindMultiple.call(r, e, t, n), r
          },
          m.prototype.unbind =
              function(e, t) {
            var n = this;
          ...
          m.prototype.stopCallback =
              function(e, t) {
            var n = this;
            return !((' ' + t.className + ' ').indexOf(' mousetrap ') > -1) &&
                (!g(t, n.target) &&
                 ('INPUT' == t.tagName || 'SELECT' == t.tagName ||
                  'TEXTAREA' == t.tagName || t.isContentEditable))
          },
          m.prototype.handleKey =
              function() {
            var e = this;
    ...
    function(e, t, n) {
      (function(e) {
        !function(r) {
          ...
          function f(e, t, n) {
            var r = 0;
            for (e = n ? F(e / E) : e >> 1, e += F(e / t); e > H * k >> 1;
                 r += C)
              e = F(e / H);
            return F(r + (H + 1) * e / (e + j))
          }
          function p(e) {
            var t, n, r, i, a, s, c, p, h, d, g = [], m = e.length, v = 0,
                                              y = S, b = N;
            for (n = e.lastIndexOf(A), n < 0 && (n = 0), r = 0; r < n; ++r)
              e.charCodeAt(r) >= 128 && o('not-basic'), g.push(e.charCodeAt(r));
            for (i = n > 0 ? n + 1 : 0; i < m;) {
              for (a = v, s = 1, c = C;
                   i >= m && o('invalid-input'), p = l(e.charCodeAt(i++)),
                  (p >= C || p > F((w - v) / s)) && o('overflow'), v += p * s,
                  h = c <= b      ? T :
                       c >= b + k ? k :
                                    c - b,
                  !(p < h);
              ...
              t = g.length + 1, b = f(v - a, t, 0 == a),
              F(v / t) > w - y && o('overflow'), y += F(v / t), v %= t,
              g.splice(v++, 0, y)
            }
            return u(g)
          }
          function h(e) {
            ...
            for (r = i = x.length, i && x.push(A); r < m;) {
              for (l = w, u = 0; u < m; ++u)
                g = e[u], g >= t && g < l && (l = g);
              for (v = r + 1, l - t > F((w - n) / v) && o('overflow'),
                  n += (l - t) * v, t = l, u = 0;
                   u < m; ++u)
                if (g = e[u], g < t && ++n > w && o('overflow'), g == t) {
                  for (p = n, h = C; d = h <= a     ? T :
                      ...
                      !(p < d);
                       h += C)
                    b = p - d, y = C - d, x.push(P(c(d + b % y, 0))),
                    p = F(b / y);
          ...
          var b, x,
              w = 2147483647, C = 36, T = 1, k = 26, j = 38, E = 700, N = 72,
              S = 128, A = '-', q = /^xn--/, D = /[^\x20-\x7E]/,
              O = /[\x2E\u3002\uFF0E\uFF61]/g, L = {
      ...
      t.exports = function(e, t, n, i) {
        ...
        for (var c = 0; c < l; ++c) {
          ...
          m >= 0 ? (f = g.substr(0, m), p = g.substr(m + 1)) : (f = g, p = ''),
              h = decodeURIComponent(f), d = decodeURIComponent(p),
  ...
  5: [
    function(e, t, n) {
      ...
      t.exports = function(e, t, n, s) {
        return t = t || '&', n = n || '=', null === e && (e = void 0),
               'object' == typeof e ?
                   r(a(e),
                     function(a) {
  ...
  7: [
    function(e, t, n) {
      ...
      var c = /^([a-z0-9.+-]+:)/i, f = /:[0-9]*$/,
          p = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/,
          h = ['<', '>', '"', '`', ' ', '\r', '\n', '\t'],
          d = ['{', '}', '|', '\\', '^', '`'].concat(h), g = ['\''].concat(d),
          m = ['%', '/', '?', ';', '#'].concat(g), v = ['/', '?', '#'], y = 255,
          b = /^[+a-z0-9A-Z_-]{0,63}$/, x = /^([+a-z0-9A-Z_-]{0,63})(.*)$/,
      ...
      r.prototype.parse = function(e, t, n) {
        ...
        var r = e.indexOf('?'), o = r !== -1 && r < e.indexOf('#') ? '?' : '#',
            i = e.split(o), a = /\\/g;
        ...
        if (s = s.trim(), !n && 1 === e.split('#').length) {
          var f = p.exec(s);
          if (f)
            return this.path = s, this.href = s, this.pathname = f[1],
                   f[2] ? (this.search = f[2],
                           t ? this.query = k.parse(this.search.substr(1)) :
        ...
        if (!C[h] && (j || h && !T[h])) {
          ...
          E === -1 && (E = s.length), this.host = s.slice(0, E), s = s.slice(E),
                                      this.parseHost(),
                                      this.hostname = this.hostname || '';
          var D = '[' === this.hostname[0] &&
              ']' === this.hostname[this.hostname.length - 1];
          if (!D)
            for (var O = this.hostname.split(/\./), N = 0, L = O.length; N < L;
                 N++) {
              var H = O[N];
              if (H && !H.match(b)) {
          ...
          this.host = W + _, this.href += this.host,
          D &&
              (this.hostname =
        ...
        var X = s.indexOf('?');
        if (X !== -1 ?
                (this.search = s.substr(X), this.query = s.substr(X + 1),
                 t && (this.query = k.parse(this.query)), s = s.slice(0, X)) :
                t && (this.search = '', this.query = {}),
            s && (this.pathname = s),
        ...
        this.host ? o = e + this.host :
                ...
                (o = e +
                 ...
                 this.port && (o += ':' + this.port)),
                    this.query && l.isObject(this.query) &&
            Object.keys(this.query).length && (i = k.stringify(this.query));
        ...
        if (e.slashes && !e.protocol) {
          ...
          return T[n.protocol] && n.hostname && !n.pathname &&
                     (n.path = n.pathname = '/'),
                 n.href = n.format(), n
        }
        if (e.protocol && e.protocol !== n.protocol) {
          ...
          if (n.protocol = e.protocol, e.host || C[e.protocol])
            ...
            for (var d = (e.pathname || '').split('/');
                 d.length && !(e.host = d.shift());)
              ;
            e.host || (e.host = ''), e.hostname || (e.hostname = ''),
                '' !== d[0] && d.unshift(''), d.length < 2 && d.unshift(''),
                n.pathname = d.join('/')
          }
          if (n.search = e.search, n.query = e.query, n.host = e.host || '',
              n.auth = e.auth, n.hostname = e.hostname || e.host,
              n.port = e.port, n.pathname || n.search) {
        ...
        if (k &&
          ...
          n.search = e.search, n.query = e.query, w = d;
        else if (d.length)
          w || (w = []), w.pop(), w = w.concat(d), n.search = e.search,
                                  n.query = e.query;
          ...
          return n.search = e.search, n.query = e.query,
        ...
        if (!w.length)
          return n.pathname = null,
                 ...
                 n.href = n.format(), n;
        for (var E = w.slice(-1)[0],
                 N = (n.host || e.host || w.length > 1) &&
                     ('.' === E || '..' === E) ||
                 '' === E,
                 S = 0, A = w.length;
             A >= 0; A--)
        ...
        return b = b || n.host && w.length, b && !q && w.unshift(''),
               w.length ? n.pathname = w.join('/') :
                          (n.pathname = null, n.path = null),
               l.isNull(n.pathname) && l.isNull(n.search) ||
                   (n.path = (n.pathname ? n.pathname : '') +
                        (n.search ? n.search : '')),
               n.auth = e.auth || n.auth, n.slashes = n.slashes || e.slashes,
               n.href = n.format(), n
      }, r.prototype.parseHost = function() {
        var e = this.host, t = f.exec(e);
        t &&
            (t = t[0], ':' !== t && (this.port = t.substr(1)),
  ...
  10: [
    function(e, t, n) {
      ...
      var o = e('./dropdown'), i = e('./keyboard'), a = e('./navigation'),
          s = e('./sidebar'), u = e('./toolbar'), l = window.gitbook;
      l.events.on('start', r), l.keyboard = i, l.navigation = a, l.sidebar = s,
                               l.toolbar = u
    },
    {
      './dropdown': 9,
  ...
  13: [
    function(e, t, n) {
      ...
      function u(e) {
        var t = r(), n = t.find('.page-inner'), o = t.find(e),
            i = o.offsetParent(), u = 0;
        if (s([t, n, o, i], a)) return 0;
        u = o.position().top;
        for (var l = 10, c = 0; c < l && (!i.is(n) && !i.is(i.offsetParent()));
             c++)
      ...
      function l(e, t) {
        if (e || t || (e = w.first()),
            t &&
                (e = w.length > 1 ? w.filter(function() {
                                       var e = c(T(this));
                                       return e == t
                                     }).first() :
                                    w.first()),
      ...
      function f() {
        var e = r(), t = e.scrollTop(), n = e.prop('scrollHeight'),
            o = e.prop('clientHeight'), i = w.length, a = null;
      ...
      function p(e, t) {
        var n = k.parse(A), r = k.resolve(window.location.pathname, e),
            i = k.parse(r), a = i.hash, s = i.pathname !== n.pathname,
               ...
               T.ajax({
                 ...
                 success: function(n, i, s) {
                   ...
                   t && history.pushState({path: u}, null, u),
                       c = T(n), l = c.find('[data-element=head]'),
                       f = c.find('.book'),
                   ...
                   f.toggleClass(
                       'with-summary', T('.book').hasClass('with-summary')),
                       T('.book').replaceWith(f), T('.book').attr('class', g),
      ...
      function d(e) {
        var t = T('.book-body'), n = t.find('.body-inner'),
      ...
      function x() {
        T.ajaxSetup({cache: !1}),
            ...
            T(document).on('click', '.page-inner a', v), T(window).resize(h),
            d(!1)
      }
      var w, C, T = e('jquery'), k = e('url'), j = e('./loading'),
                E = e('./platform'), N = window.gitbook,
  ...
  16: [
    function(e, t, n) {
      ...
      function o(e, t, n, r) {
        ...
        n < 0 && (n = Math.max(0, o + 1 + n)), e.append(r),
        ...
        if ('string' == typeof e)
          ...
          n.forEach(function(e) {
            ...
            e.forEach(function(e) {
              ...
              var t =
                  p('<button>',
                    {class: 'button ' + r + ' ' + e.className, text: e.text});
      ...
      function u(e) {
        var t, n = p('.book-header'), r = n.find('h1'),
               i = 'pull-' + e.position, s = p('<a>', {
                                           class: 'btn',
                                           text: e.text ? ' ' + e.text : '',
                                           'aria-label': e.label,
                                           href: '#'
        ...
        if (s.click(e.onClick),
            e.icon && p('<i>', {class: e.icon}).prependTo(s), e.dropdown) {
